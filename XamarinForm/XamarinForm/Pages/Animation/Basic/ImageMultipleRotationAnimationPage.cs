...
{
	public class ImageMultipleRotationAnimationPage : ContentPage
    {
        Image image;
        Button startButton, stopButton;
        

        public ImageMultipleRotationAnimationPage ()
        {
            Grid grid = new Grid
            {
        ...
        private async void StartButton_Clicked(object sender, System.EventArgs e)
        {
            ...
            await Task.WhenAll(
                image.RotateTo(200 * 360, duration),
                image.RotateXTo(150 * 360, duration),
                image.RotateYTo(100 * 360, duration)
            );
